    ...
    <section className="mx-auto mt-24 max-w-7xl px-4 sm:px-6">
      ...
      <div className="mt-8 grid gap-4 sm:grid-cols-2">
        {STEPS.map((step) => (
          <div
            key={step.id}
            className={`rounded-[24px] border p-5 transition-all duration-300 hover:-translate-y-1 ${'highlighted' in step && step.highlighted
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div className={`flex h-8 w-8 items-center justify-center rounded-lg border ${'highlighted' in step && step.highlighted
              ...
              <div className="flex items-center gap-1.5 rounded-full border border-white/8 bg-white/[0.02] px-2.5 py-1">
                ...
                <span className="font-mono text-[11px] font-medium text-[#64748B]">{step.duration}</span>
              </div>
            </div>
