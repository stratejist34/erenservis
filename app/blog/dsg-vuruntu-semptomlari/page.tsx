    ...
    <main className="bg-[#070B11]">
      ...
      <section className="hero-deep pt-28 pb-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-hero-muted text-lg leading-relaxed max-w-2xl mx-auto mb-8">
            ...
            1→2 ve 2→3 vuruntu olarak hissedilebilir. <strong className="text-hero-muted font-medium">Bostancı erken teşhis</strong>.
          </p>
      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 py-16">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-content-text mb-6">DSG Vuruntu Belirtileri</h2>
            ...
            {NEDENLER.map((neden) => (
              <div key={neden.baslik} className="p-5 rounded-xl bg-[#070B11] border border-content-border shadow-sm">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-bold text-content-text mb-1">{neden.baslik}</h3>
                    <p className="text-content-muted text-sm">{neden.aciklama}</p>
                  </div>
                </div>
              </div>
            ))}
        ...
        {/* Erken Teşhis */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-content-text mb-6">Erken Teşhis ve Maliyet</h2>
      ...
      <section className="hero-deep py-14 text-center">
        <div className="max-w-2xl mx-auto px-4 sm:px-6">
          <h2 className="text-hero-text mb-4">DSG Vuruntu Probleminiz mi Var?</h2>
