...
const DEFAULT_TITLE = 'Şanzıman sorunu büyümeden teşhis edelim';
const DEFAULT_SUBTITLE =
  'DSG, ZF, CVT ve tam otomatik şanzımanlarda aynı gün inceleme, yazılı teklif ve kontrollü onarım akışı sunuyoruz.';
  ...
  return (
    <section className="mx-auto mt-24 max-w-7xl px-4 sm:px-6">
      <div className="relative overflow-hidden rounded-2xl border border-border-subtle bg-graphite-elevated px-8 py-14 text-center">
        ...
        <p className="mt-5 font-jetbrains text-[11px] text-text-secondary">
          Ücretsiz ön teşhis için arayın ya da aracınızdaki belirtinin kısa özetini WhatsApp'tan paylaşın.
        </p>
